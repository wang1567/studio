...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('寵物專區 API 代理請求開始...');
    console.log('查詢參數:', { q, limit, offset });

    // 構建台北市政府 API URL
    const apiUrl = new URL('https://data.taipei/api/v1/dataset/609df33e-d8f1-4c8a-ac47-12cc5767ff03');
    apiUrl.searchParams.append('scope', 'resourceAquire');
    apiUrl.searchParams.append('resource_id', '609df33e-d8f1-4c8a-ac47-12cc5767ff03');
    ...
    console.error('寵物專區 API 代理錯誤:', error);
